                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            <label>
                                ...
                                <input @if($permission1['from']=='role' && $permission1['can']) disabled @endif
                                name="permission_id[]" type="checkbox"  @if($permission1['can']) checked @endif value="{{$permission1['id']}}">
                        ...
                        <div class="form-group">
                          ...
                          <h4 style="margin: 0px;padding-left: 13px;">
                           <input @if($permission2['from']=='role' && $permission2['can']) disabled @endif
                           name="permission_id[]" type="checkbox" @if($permission2['can']) checked @endif value="{{$permission2['id']}}">
                          ...
                          @foreach($permissions->where('pre_permission_id',$permission2['id'])->all() as $permission3)
                            <div class="col-sm-3">
                              <div class="checkbox">
                                  <label>
                                      <input @if($permission3['from']=='role' && $permission3['can']) disabled @endif
                                      name="permission_id[]" type="checkbox" @if($permission3['can']) checked @endif value="{{$permission3['id']}}">
